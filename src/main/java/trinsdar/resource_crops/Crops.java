...
public class Crops {
    ...
    public static CropCard cropCanola = registerCrop(new CropCanola(), new ItemStack(InitItems.itemMisc, 1, 13));
    public static CropCard cropFlax = registerCrop(new CropFlax(), new ItemStack(Items.STRING));
    public static CropCard cropRice = registerCrop(new CropRice(), new ItemStack(InitItems.itemFoods, 1, 16));
